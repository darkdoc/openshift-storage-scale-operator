...
// +kubebuilder:validation:Enum=v5.2.2.1;v5.2.3.0.rc1;v5.2.3.0.dummy
...
type FusionAccessSpec struct {
	...
	// +operator-sdk:csv:customresourcedefinitions:type=spec,order=2,xDescriptors={"urn:alm:descriptor:com.tectonic.ui:select:v5.2.2.1","urn:alm:descriptor:com.tectonic.ui:select:v5.2.3.0.rc1","urn:alm:descriptor:com.tectonic.ui:select:v5.2.3.0.dummy"}
